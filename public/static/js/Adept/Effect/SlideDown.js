...
Adept.Effect.SlideDown = Class.create(Adept.Effect.Base,
{
    ...
    {
        this.setOption('scaleTo', scaleTo);
        return this;
    },
    scaleFrom :function(scaleFrom)
    {
        this.setOption('scaleFrom', scaleFrom);
        return this;
    },
    
    go: function()
    {
        return new Effect.SlideDown(this.element, this.options);
    }
