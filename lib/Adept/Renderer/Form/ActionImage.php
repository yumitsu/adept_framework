...
class Adept_Renderer_Form_ActionImage extends Adept_Renderer_Base_Button
{
    protected $clientControllerClass = 'Adept.Controller.Form.ActionButton';

    /**
     * @param Adept_Component_Form_ActionImage $component
     */
    public function renderBegin($component)
    {
        ...
        $attributes = array('id' => $clientId, 'type' => 'image',
