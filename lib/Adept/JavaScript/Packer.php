 ...
 * Ported to Adept by Sergey Paramonov
 * 
 * ----------------------------------------------------------------------
 */

class Adept_JavaScript_Packer {
    // constants
    const IGNORE = '$1';
    ...
    private function _basicCompression($script) {
        $parser = new Adept_JavaScript_ParseMaster();
        // make safe
        $parser->escapeChar = '\\';
        // protect strings
        $parser->add('/\'[^\'\\n\\r]*\'/', self::IGNORE);
    ...
    private function _bootStrap($packed, $keywords) {
        ...
        $unpackPacker = new Adept_JavaScript_Packer($unpack, 0, false, true);
